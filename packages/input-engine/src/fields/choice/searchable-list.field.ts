...
export class SearchableListFieldHandler implements FieldHandler {
  readonly fieldType = 'SearchableList' as const;
  ...
  validate(value: unknown, _schema: unknown, metadata: FieldMetadata): Result<unknown, AppError> {
    ...
    // If dataSource is provided (async), just validate non-empty string

...
- **Mitigation:** Circuit breaker after 5 failures; BullMQ queue retries with exponential backoff; graceful degradation to manual input (Constitution Rule XXXIII); SUPER_ADMIN notified when circuit opens

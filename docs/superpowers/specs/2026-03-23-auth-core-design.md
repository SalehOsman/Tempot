...
_(Note: In Gemini CLI environments, these tasks will be executed sequentially by the generalist or executing-plans agent, but the decoupled design remains identical)._

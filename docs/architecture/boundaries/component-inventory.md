...
| `docs/ROADMAP.md` | Project status source of truth | Must be updated after merge-impacting work |
| `docs/architecture/adr/` | Accepted architectural decisions | Required before architectural implementation |

...
- Confirmation flows for backup, restore rehearsal, live restore, and factory
  reset.
- Retention status summaries. Retention deletion authorization exists in the
  ability policy, but artifact deletion is not exposed as a current Telegram
  workflow.

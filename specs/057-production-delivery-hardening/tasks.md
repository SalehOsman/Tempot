...
- [x] T008 [US1] Refactor `apps/bot-server/src/startup/deps.factory.ts` to validate every initializer and map failures to Result/AppError
- [x] T009 [US1] Add explicit startup-stage state and readiness activation
- [x] T010 [US1] Reconcile optional dependency degradation and required-provider configuration
- [x] T011 [US1] Verify one-time logging and graceful shutdown for each failure
...
- [x] T018 [US2] Make thresholds configurable and align defaults with the constitution

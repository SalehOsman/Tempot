...
- [x] T002 [P] Review `docs/archive/tempot_architecture.md`, `.specify/memory/constitution.md`, and `docs/archive/developer/workflow-guide.md` for existing boundary and methodology language.

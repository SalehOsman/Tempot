...
- **Provider Safety Refusal Handling**: Superseded on 2026-04-29 by Spec #028. The implemented package does not expose a dedicated provider-refusal error code. Future provider-specific refusal detection must be specified in a new feature before implementation.

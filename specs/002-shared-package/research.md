...
| Cache-manager version        | Spec says "6.x" (FR-001)                        | `cache-manager 6.4.0` (v6)                           | v6 was current at implementation time; uses Keyv adapters instead of v5 custom stores              |

...
>
> 📄 **Plan file:** [`docs/superpowers/plans/2026-03-19-016-document-engine-package.md`](../../docs/superpowers/plans/2026-03-19-016-document-engine-package.md)
...
| Field | Value |
|---|---|
| **Related spec** | `specs/016-document-engine-package/spec.md` |
| **Plan file** | `docs/superpowers/plans/2026-03-19-016-document-engine-package.md` |
| **Phase** | Phase 4 — Advanced Engines |
| **Dependencies** | `002-shared-package`, `010-storage-engine-package` |
| **Dependents** | `017-import-engine-package`, all modules generating PDF/Excel reports |
